...
const Favourites = ({data,selectedProject,setSelectedProject}) => {
  ...
  return (
    <div>
      <Collapse accordion defaultActiveKey={['1']} expandIconPosition="end" bordered={false} className="bg-sidenav m-0">
        <Panel header="Favourites" key="1">
         <IndividualProject list={favourites} selectedProject={selectedProject} setSelectedProject={setSelectedProject}/>
        </Panel>
      </Collapse>
    </div>
  );
